        ...
        {isSuccess ? (
          <div className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="nickname" className="text-xs font-semibold text-slate-500">
                Give it a nickname
              </Label>
              <Input
                id="nickname"
                ...
                className="w-full h-11 bg-white border border-slate-200 rounded-[10px] text-sm focus-visible:ring-2 focus-visible:ring-emerald-500/20 focus-visible:border-emerald-500 focus-visible:outline-none"
              />
            </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              variant="outline"
              onClick={onClose}
              className="w-full h-12 border border-slate-200 text-slate-600 hover:bg-slate-50 rounded-full font-semibold text-sm transition-colors"
            >
              Go Back
            </Button>
          </div>
