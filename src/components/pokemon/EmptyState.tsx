...
export default function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-16 px-4 max-w-sm mx-auto w-full col-span-2">
      <SearchX size={48} className="text-slate-300 dark:text-slate-600 mb-4 transition-colors duration-200" />
      <h3 className="font-display text-base font-semibold text-slate-500 dark:text-slate-400 mb-4 transition-colors duration-200">
        {message}
      </h3>
